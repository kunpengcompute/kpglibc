...
- [2026.06.30]：发布v1.0.4版本，针对鲲鹏950处理器持续优化memcmp函数。
- [2026.03.30]：发布v1.0.3版本，新增针对鲲鹏950处理器优化的memcpy/memmove/memcmp/memset函数，在大部分场景有加速效果。
...
| kpglibc | 开源Glibc | 特性 |
| ------------ | ------------ | ------------ |
| v1.0.4 | 对标Glibc 2.31，不局限于2.31版本，系统Glibc为其他版本也可以使能 | 针对鲲鹏950处理器持续优化memcmp函数。 |
